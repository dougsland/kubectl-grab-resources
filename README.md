# KUBECTL PACK
**kubectl pack** plugin detects resources required from the deployment name provided in the script (in any namespace) and export all requirements in a single YAML. 
